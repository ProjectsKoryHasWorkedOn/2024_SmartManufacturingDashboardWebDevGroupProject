...
?>
<script type="text/javascript" src="import/js/timeJobsToDo.js" defer></script>
...
<div id="header_middle">
  <p id="current_time" class="numbers_font">Current time</p>
</div>
<div id="header_right">
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', (event) => {
    let url = "<?php echo $lotsOfTimesPHPFilePath ?>";
